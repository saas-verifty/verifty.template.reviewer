...
describe('Alert Component', () => {
  ...
  describe('Rendering', () => {
    it('should render success alert with message', () => {
      // Arrange & Act
      render(<Alert type="success" message="Operation successful" onClose={mockOnClose} />);
    ...
    it('should render error alert with message', () => {
      // Arrange & Act
      render(<Alert type="error" message="Something went wrong" onClose={mockOnClose} />);
  ...
  describe('Interactions', () => {
    ...
    it('should not call onClose when message is clicked', () => {
      // Arrange
      render(<Alert type="success" message="Test Message" onClose={mockOnClose} />);
  ...
  describe('Accessibility', () => {
    ...
    it('should display message text in readable format', () => {
      // Arrange
      const longMessage = 'This is a longer error message that should be fully visible to the user';
